...
python_expert_agent = Agent(
    ...
    description="Receives Python project context and code, then creates deep detailed documentation.",
    instruction=f"""
    You are a Python senior technical writer creating official, user-friendly documentation. 
    ...
    **IMPORTANT CONSTRAINTS:**
    ...
    - Once the documentation is written and finalized, use the 'save_documentation_as_html' tool to save it and return to root agent.
""",
    tools=[],
)
