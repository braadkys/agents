...
async def run_conversation_loop():
    ...
    print(f"Session '{session_id_for_this_run}' created for app '{APP_NAME}', user '{DEFAULT_USER_ID}'.")
    ...
    print("-" * 70)
    print(f"Starting chat with {project_documentation_team.name}. Type 'quit' or 'exit' to end.")
    print("-" * 70)
